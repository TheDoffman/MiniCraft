...
export const MUTTON_HUNGER_RESTORE = 32;
export const RAW_CHICKEN_HUNGER_RESTORE = 28;
/** Cooked meats restore more than raw. */
export const STEAK_HUNGER_RESTORE = 50;
export const COOKED_PORKCHOP_HUNGER_RESTORE = 48;
export const COOKED_MUTTON_HUNGER_RESTORE = 44;
export const COOKED_CHICKEN_HUNGER_RESTORE = 42;
/** Rotten flesh — separate from raw meats for tuning. */
export const ROTTEN_FLESH_HUNGER_RESTORE = 14;
export const BREAD_HUNGER_RESTORE = 40;
...
export const TARGET_SHEEP_COUNT = 10;
export const TARGET_CHICKEN_COUNT = 10;
...
/** Multiply break duration while the player is in water (swimming). */
export const UNDERWATER_MINE_TIME_MULTIPLIER = 3;
