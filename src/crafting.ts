...
addFrom2x2(
  [BlockId.SAND, BlockId.SAND, BlockId.SAND, BlockId.SAND],
  { blockId: BlockId.SANDSTONE, count: 1 },
);
...
addFrom2x2([BlockId.SHORT_GRASS, 0, 0, 0], { blockId: BlockId.WHEAT_SEEDS, count: 1 });
...
addFrom2x2([BlockId.DIAMOND, BlockId.DIAMOND, BlockId.STICK, 0], { blockId: BlockId.DIAMOND_PICKAXE, count: 1 });
addFrom2x2([BlockId.DIAMOND, BlockId.DIAMOND, 0, BlockId.STICK], { blockId: BlockId.DIAMOND_AXE, count: 1 });
addFrom2x2([BlockId.DIAMOND, 0, BlockId.STICK, 0], { blockId: BlockId.DIAMOND_SHOVEL, count: 1 });
addFrom2x2([BlockId.DIAMOND, BlockId.STICK, 0, 0], { blockId: BlockId.DIAMOND_SWORD, count: 1 });

addFrom2x2([BlockId.DIAMOND, BlockId.DIAMOND, 0, 0], { blockId: BlockId.DIAMOND_HELMET, count: 1 });
addFrom2x2([BlockId.DIAMOND, 0, BlockId.DIAMOND, 0], { blockId: BlockId.DIAMOND_CHESTPLATE, count: 1 });
addFrom2x2([0, 0, BlockId.DIAMOND, BlockId.DIAMOND], { blockId: BlockId.DIAMOND_LEGGINGS, count: 1 });
addFrom2x2([0, BlockId.DIAMOND, BlockId.DIAMOND, 0], { blockId: BlockId.DIAMOND_BOOTS, count: 1 });

addRecipe([BlockId.WHEAT, BlockId.WHEAT, BlockId.WHEAT], 3, 1, { blockId: BlockId.BREAD, count: 1 });
